...
\end{equation*}
with periodic boundary conditions on a 9-qubit subgraph. The system is evolved for a total time $T$ using a second-order symmetric (i.e., $p=1$) Trotter decomposition,
